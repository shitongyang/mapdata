...
public class JTSocket {
     ...
     */
    private static CopyOnWriteArraySet<JTSocket> webSocketSet = new CopyOnWriteArraySet();
    ...
    public void onMessage(String message) {
        for (JTSocket item : webSocketSet) {
    ...
    public void sendMessage(String message) {
        for (JTSocket socketServer : webSocketSet) {
            try {
